...
See [Architecture Overview](architecture.md) for full component descriptions. See [Key Findings](key-findings.md) for the experimental evidence behind each claim.
